...
const mockRecords = [
    ...
    {
        id: 'REC-005',
        title: 'MRI Scan Results - Lower Back',
        type: 'Imaging',
        date: 'Jun 28, 2026',
...
const mockUpcomingAppointments = [
    {
        id: 'APT-1',
        title: 'Routine Clinical Checkup',
        provider: 'Dr. Sarah Jenkins',
        date: 'Jul 22, 2026',
        time: '10:00 AM',
        type: 'clinical'
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
                <div>
                    ...
                    <p className="text-xs font-medium text-slate-500 mt-1">
                        View and manage your health history, prescriptions, and upcoming clinical visits.
                    </p>
                </div>
            ...
            <div className="flex flex-col lg:flex-row gap-4">
                <div className="flex-1 bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden flex flex-col">
                    ...
                    <div className="p-3 border-t border-slate-100 flex items-center justify-between text-[10px] font-medium text-slate-500 bg-slate-50/50">
                        ...
                        <div className="flex gap-1">
                            ...
                            <Button variant="ghost" size="sm" className="h-6 text-[10px] px-2">2</Button>
                ...
                <div className="w-full lg:w-80 flex flex-col gap-4">
                    ...
                    <div className="bg-gradient-to-br from-primary/5 to-secondary/5 rounded-xl border border-primary/10 p-4">
                        ...
                        <p className="text-[10px] font-medium text-slate-500 mb-3">Add external prescriptions or reports.</p>
