            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
                <div>
                    ...
                    <p className="text-xs font-medium text-slate-500 mt-1">
                        Explore and book premium out-of-pocket services beyond your active subscription.
                    </p>
                </div>
                        ...
                        <div className="flex-1 overflow-y-auto p-5 space-y-5 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-slate-200 [&::-webkit-scrollbar-thumb]:rounded-full">
                            ...
                            <div className="bg-amber-50 rounded-xl p-3 border border-amber-100 flex items-start gap-2">
                                ...
                                <p className="text-[11px] font-medium text-amber-800 leading-relaxed">
                                    This is an out-of-pocket service not covered by your current active subscription plan. You will be billed separately for this visit.
                                </p>
                            </div>
                                ...
                                <div className="flex flex-col gap-1.5 w-full">
                                    <div className="relative">
                                        ...
                                        <textarea
                                            ...
                                            placeholder="Provide any specific medical conditions, instructions, or requirements..."
                                        ></textarea>
                                    </div>
                                </div>
                            </div>
...
export default CareServicesCom;