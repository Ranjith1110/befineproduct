...
const ParentsHomeCareServicesCom = () => {
                            ...
                            {selectedService.isPaid ? (
                                <div className="bg-amber-50 rounded-xl p-3 border border-amber-100 flex items-start gap-2">
                                    ...
                                    <p className="text-[11px] font-medium text-amber-800 leading-relaxed">
                                        This is a paid home care service not covered by {activeParent.label.split(' (')[0]}'s plan. You will be billed separately for this visit.
                                    </p>
                                </div>
                            ) : (
                                <div className="bg-emerald-50 rounded-xl p-3 border border-emerald-100 flex items-start gap-2">
                                    ...
                                    <p className="text-[11px] font-medium text-emerald-800 leading-relaxed">
                                        This consultation is provided free of charge as part of {activeParent.label.split(' (')[0]}'s onboarding or active subscription benefits.
                                    </p>
                                </div>
                            )}
                                ...
                                <div className="flex flex-col gap-1.5 w-full">
                                    <div className="relative">
                                        ...
                                        <textarea
                                            ...
                                            placeholder={`Provide any specific instructions, routines, or requirements for ${activeParent.label.split(' (')[0]}...`}
                                        ></textarea>
                                    </div>
                                </div>
                            </div>
...
export default ParentsHomeCareServicesCom;