...
const ParentsSponsoredServicesCom = () => {
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
                <div>
                    <h1 className="text-2xl font-bold text-slate-900 font-heading tracking-tight mb-1 flex items-center gap-2">
                        Parents Sponsored Services
                    </h1>
                    <div className="flex items-center gap-2 mt-1.5">
                        <span className="text-xs font-medium text-slate-500">Managing services for:</span>
                        <div className="w-64">
                            <Select
                ...
                <div className="flex flex-col items-end gap-1">
                    <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Active Subscription</span>
                                    ...
                                    <div className="flex flex-col gap-2">
                                        <div className="flex items-start gap-1.5 text-rose-600 px-1">
                                            ...
                                            <span className="text-[10px] font-medium leading-tight">
                                                Sponsored limit exhausted. Book this service out-of-pocket via Parents Care Services.
                                            </span>
                                        </div>
                                        <Button
                                            variant="secondary"
                                ...
                                <div className="flex flex-col gap-1.5 w-full">
                                    ...
                                    <div className="relative">
                                        ...
                                        <textarea
                                            ...
                                            placeholder={`Provide any specific details or requirements for ${activeParent.label.split(' (')[0]}'s visit...`}
                                        ></textarea>
                                    </div>
                                </div>
                            </div>
...
export default ParentsSponsoredServicesCom;