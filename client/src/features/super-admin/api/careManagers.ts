...
export const createCareManagerApi = async (payload: Partial<CreateCareManagerPayload>) => {
    ...
    try {
        response = await apiClient(SUPER_ADMIN_API_ENDPOINTS.careManagers.collection, {
            method: 'POST',
            headers: {
...
export const updateCareManagerApi = async (uuid: string, payload: Partial<CreateCareManagerPayload>) => {
    ...
    try {
        response = await apiClient(SUPER_ADMIN_API_ENDPOINTS.careManagers.byId(uuid), {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
            },
...
export const getServiceProvidersApi = async () => {
    try {
        const response = await apiClient(SUPER_ADMIN_API_ENDPOINTS.serviceProviders.listWithLimit500, {
            method: 'GET',
